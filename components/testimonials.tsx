...
const testimonials = [
  {
    ...
    name: "MaKayla P.",
    company: "Disney - Marketing Specialist",
    content:
      "JobMatch helped me land my dream job in just two weeks! The personalized job recommendations made my search so much easier.",
    categories: [1, 3, 5],
  },
  {
    ...
    name: "Andrew K.",
    company: "Samsung - HR Manager",
    content:
      "As a recruiter, finding top talent has never been this efficient. JobMatch streamlines the hiring process effortlessly!",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "UX Designer",
    content:
      "I was able to transition to a remote job seamlessly, thanks to JobMatch’s tailored job listings.",
    categories: [1, 2, 5],
  },
  {
    ...
    name: "Pavel M.",
    company: "Canon - Software Developer",
    content:
      "The AI-powered job matching is a game changer! It connected me with opportunities that perfectly aligned with my skills and career goals.",
    categories: [1, 4],
  },
  {
    ...
    name: "Miriam E.",
    company: "Cadbury - Project Manager",
    content:
      "JobMatch saved me hours of job searching by delivering high-quality, relevant job openings directly to me.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "JobMatch provided me with an incredible career growth opportunity. The job suggestions were perfectly suited to my experience and interests!" ,
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
     "Thanks to JobMatch, I secured an amazing job in my industry without the usual hassle. The AI-powered recommendations were spot on!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "This platform makes job searching so much easier! Within days, I had multiple interviews lined up." ,
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
     "The best job platform I’ve used! I got interview requests within days of signing up.",
    categories: [1, 2],
  },
];
